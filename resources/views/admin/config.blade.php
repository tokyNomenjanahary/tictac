                        ...
                        <div class="box-body" id="content-list-phrase">
                            ...
                            <!--  Id pixel fb   -->
                             ...
                             <div class="row">
                                ...
                                {{-- Nombre max pour le toctoc à chaque lancement d'une heur sur cron  --}}
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                            <label>Nombre max de toctoc par jour</label>
                                            <input type="text" class="form-control" placeholder="Nombre max pour les toctoc chaque heur" name="nb_max_toctoc" value="{{getConfig('nb_max_toctoc')}}"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                            <label>Nombre max de toctoc pour le receveur par jour </label>
                                            <input type="text" class="form-control" placeholder="Nombre max pour les toctoc chaque heur" name="nbr_max_toctoc_receive" value="{{getConfig('nbr_max_toctoc_receive')}}"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                            <label>Nombre max de toctoc pour le receveur par execution </label>
                                            <input type="text" class="form-control" placeholder="Nombre max pour les toctoc par exécution" name="nbr_max_toctoc_receive_exec" value="{{getConfig('nbr_max_toctoc_receive_exec')}}"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                            <label>Nbr jour pour l'affichage Ads crées par les community</label>
                                            <input type="text" class="form-control" placeholder="nombre de jour pour l'affichage des annonces crées par les community" name="nbJourAdsCommunity" value="{{getConfig('nbJourAdsCommunity')}}"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="display:none;">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                            <label>Crawl config :</label>
                                            <input type="text" class="form-control" placeholder="crawl" name="crawl"/>
                                        </div>
                                    </div>
                                </div>
                                 <!-- crawl config -->
