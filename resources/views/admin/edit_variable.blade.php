...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
                ...
                <form method="post" action="{{route('sauver_propriete')}}">
                    @csrf
                        @foreach ($edites as $edite)
                        <div class="form-group">
                            <label for="devise">Entrer nouveau valeur</label>
                            <input type="text" class="form-control" id="devise" name="valeur" value="{{$edite->nom}}">
                        </div> 
                        @endforeach
