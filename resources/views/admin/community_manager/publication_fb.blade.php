...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Statistique de Publication dans les groupes ou pages Facebook
        </h1>
    </section>
    <!-- Main content -->
            ...
            <div class="col-xs-12">
                    <div class="row">
                        <div class="box box-primary filtre-box">
                            ...
                            <div class="col-sm-2 col-md-2 col-xs-4 filtre-col" style="margin-bottom: 20px;">
                                <label>Groupe ou Page </label>

                                <select id="sel-fb" class="groupe selectpicker">
                                    <option value="0"></option>
                                    <option @if(isset($currentChoi) && $currentChoi == 1) selected @endif value="1">Groupe</option>
                                    <option @if(isset($currentChoi) && $currentChoi == 2) selected @endif value="2">Page</option>
                    ...
                    <!-- /.box-header -->
                        ...
                        <div class="box-body table-responsive no-padding db-table-outer">
                            <table class="table table-hover">
                                ...
                                <tr>
                                <td id=""><a href="{{$d->lien}}" target="_blank">{{$d->lien}}</a></td>
