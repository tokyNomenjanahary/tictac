                    ...
                    <div class="row">
                        <div class="box box-primary filtre-box">
                            ...
                            <div class="col-sm-2 col-md-2 col-xs-4 filtre-col" style="margin-bottom: 20px;">
                                ...
                                <select id="sel-work" class="filtre selectpicker">
                                    <option value="0"></option>
                                    @if($work == 1)
                                    <option  selected value="1">Day worked</option>
                                    <option   value="2">Day not worked</option>
                                    @else
                                    <option  selected value="2">Day not worked</option>
                                    <option   value="1">Day worked</option>      
                                    @endif
                                </select>
                            </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <td id="">
                                    <div style="margin-bottom: 20px;">
                                        <div class="Total">
                                    @if($work == 1)
                                        <?php $dateWs =  CommunityWork($starts, $ends, $d->idd, 1); ?>
                                        @foreach($dateWs as $dateW)
                                             {{$dateW}} |
                                        @endforeach
                                    @else
                                        <?php $dateWs =  CommunityWork($starts, $ends, $d->idd, 2); ?>
                                        @foreach($dateWs as $dateW)
                                             {{$dateW}} |
                                        @endforeach
                                    @endif
