                    ...
                    <!-- /.box-header -->
                        ...
                        <div class="box-body table-responsive no-padding db-table-outer">
                            <table class="table table-hover">
                                ...
                                <?php $CountN =  pubCommunityListCheck($starts, $ends, $d->idd, 1); ?>
                                <?php $CountOk =  pubCommunityListCheck($starts, $ends, $d->idd, 2); ?>
                                <?php $CountKo =  pubCommunityListCheck($starts, $ends, $d->idd, 3); ?>
                                <?php $CountVe =  pubCommunityListCheck($starts, $ends, $d->idd, 4); ?>
