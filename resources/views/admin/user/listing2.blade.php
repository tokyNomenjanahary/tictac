                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                @if(!empty($user->etape_inscription) )
                                    ...
                                    <a title="Disable" class="action-toggle-on" href="{{url(getConfig('admin_prefix') . '/siteusers/'.base64_encode($user->id).'/0')}}"><i class="fa fa-toggle-on"></i></a>
                                    @else
                                    <a title="Enable" class="action-toggle-off" href="{{url(getConfig('admin_prefix') . '/siteusers/'.base64_encode($user->id).'/1')}}"><i class="fa fa-toggle-off"></i></a>
                                    @endif
                            ...
                            @else
                            <tr>
                                <h2 class="text-danger text-center md-10">{{'Numéro introuvable dans la base'}}</h2>
                            </tr>
                            @endif
                        </table>
                    </div>
