            ...
            <div class="row no-print" style="margin-top: 15px;padding-left:50px;">
                <div class="col-md-10 p-3">
                    <div class="float-start">
                        <h3> {{__('finance.Quittance_de_loyer')}}</h3>
                    </div>
                </div>
                <div class="col-md-2 p-3 no-print">
                    <div class="dropdown" style="position: static !important;">
                        ...
                        <div class="dropdown-menu" style="z-index: 2000">
                            <a class="dropdown-item"  href="{{route('quittance.download', $quittance->id)}}"><i class="fas fa-download"></i>  {{__('echeance.Télécharger')}}</a>
                            ...
                            <div class="dash-tile-content-inner-fluid dash-tile-content-light printarea">
                                <div id="quittance_div">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td valign="top">
                                                <div style="width: 251px; position: relative; float:right; text-align:right; line-height: 11px;">
                                                    ...
                                                    <tr>
                                                        <td height="25" align="center" valign="middle"
                                                            style="padding: 10px;"><strong>
                                                                <font
                                                                    style="font-size:12px; text-transform: uppercase;">
                                                                    {{__('echeance.info_locataire')}} </font>
                                                            </strong></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                    ...
                                    <table class="no-print" width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                        <tr>
                                            <td width="50%" valign="top">
                                            </td>
                                            <td width="50%" valign="top" align="right">
                                                ...
                                                <br style="clear: both;"> --}}
                                                <p style="font-size:12px;"> <span>  {{ $proprietaire->first_name }}</span> </p>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>

                                    <p style="margin-bottom: 0.14in" class="no-print"></p>
                                    ...
                                    <table class="no-print" width="100%" border="0" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td>
                                                <p style="text-align:center; font-size:10px;">© Bailti </p>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
