...
@push('styles')
    ...
    <link href="https://res.cloudinary.com/dnnf3mdjs/raw/upload/v1648716488/css/countrySelect_vc8lhj.css" rel="stylesheet">
@endpush
@push('scripts')
                            ...
                            <div class="register-second-content">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                  <div class="form-group" for="budget">
                                   <label style="margin-bottom:20px;">Votre budget <sup> *</sup></label>
                                   <br>
