...
<!--[if mso]><table><tr><td class="mui-container-fixed"><![endif]-->
                        <div style="text-align:center;" class="mui-container">
                            <div class="mui-divider-bottom">
                                <a href="{{ url('/') }}">
                                    <img src="{{URL::asset('images/blue-logo-1.png')}}" alt="{{ config('app.name', 'TicTacHouse') }}"></a>
                                <div class="mui-divider-bottom"></div>

                                <p style="padding:20px; text-align:left;">
                                    {{ __('mail.hi') }}, <br><br>
                                    {{ __('mail.new_ad_title')}}.<br>
									{{ __('mail.title') . $ad->title}}<br>
									{{ __('mail.description') . $ad->description}}<br>
									{{ __('mail.address') . $ad->adress}}<br></p>
									{{ __('mail.thanks') }},<br />
                            </div>
