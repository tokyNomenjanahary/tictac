            ...
            <center>
                ...
                <div style="text-align:center;" class="mui-container">
                    <div class="mui-divider-bottom">
                        ...
                        <p style="padding:20px; text-align:left;">
                            {{ __('mail.first_message_expired1') }} "{{ $title }}" {{ __('mail.first_message_expired2') }}

                        </p>

                        <p style="padding:20px; text-align:left;">
                            <b> {{ __('mail.second_message_expired') }}</b>

                            <a href="{{ $url_reactivation }}" title="Reactivation" target="_blank" style="color: blue; text-decoration: underline;">
                                {{ __('mail.message_reactiver') }}</a>
                        </p>

                        <p style="padding:20px; text-align:left;">
                            <b> {{ __('mail.third_message_expired') }}</b>

                            <a href="{{ url('/connexion') }}" title="Login" target="_blank" style="color: blue; text-decoration: underline;">
