                        ...
                        <div style="text-align:center;" class="mui-container">
                            <div class="mui-divider-bottom">
                                ...
                                <p style="padding:20px; text-align:left;">
                                    {{ __('mail.hi') }} {{$userMessageInfo->first_name}}, <br><br>
                                    {{Auth::user()->first_name}} {{Auth::user()->last_name}} {{ __('mail.send_message')}} .<br>
									<p><a href="{{ url('/messages-boite-reception') }}">{{__('mail.view_message')}}</a><br/>
