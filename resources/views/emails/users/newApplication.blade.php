                        ...
                        <div style="text-align:center;" class="mui-container">
                            <div class="mui-divider-bottom">
                                ...
                                <p style="padding:20px; text-align:left;">
                                    {{ __('mail.hi') }} {{$userApplicationInfo->first_name}}, <br><br>
                                    {{Auth::user()->first_name}} {{Auth::user()->last_name}} {{ __('mail.new_application')}} {{$userApplicationInfo->title}} .<br>
									<p><a href="{{ url('/my-applications/received') }}">{{__('mail.view_application')}}</a></p>
									{{__('mail.thanks')}}.
								</p>
							</div>
