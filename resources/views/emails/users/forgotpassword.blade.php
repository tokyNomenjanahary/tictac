                        ...
                        <div style="text-align:center;" class="mui-container">
                            <div class="mui-divider-bottom">
                                ...
                                <p style="padding:20px; text-align:left;">
                                    {{ __('mail.hi') . ' ' . trim($user->first_name)}}, <br><br>
                                    {{ __('mail.reset_message') }}</p>
                                <a href="{{ $resetUrl }}" title="Reset" target="_blank" class="mui-btn mui-btn-primary mui-btn-lg">{{ __('mail.reset') }}</a>
                                <br><br>
                                {{ __('mail.thanks') }},<br />
                                {{ __('mail.team' ) }}
                                <br/>
