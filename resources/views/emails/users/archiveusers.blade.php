...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="{{ asset('css/mail/email-inline.css') }}" rel="stylesheet">
        <link href="{{ asset('css/mail/email-styletag.css') }}" rel="stylesheet">
    </head>
    <body>
                        ...
                        <div style="text-align:center;" class="mui-container">
                            <div class="mui-divider-bottom">
                                ...
                                <p style="padding:20px; text-align:left;">
                                   Bonjour il ya une erreur dans l'archivage des users: <br>   
                                   {{$erreur}}                        
                                   {{date('Y-m-d - H:i:s')}} .<br>
                                </p>
                            </div>
