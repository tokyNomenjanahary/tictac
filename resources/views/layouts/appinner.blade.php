...
<head>
    ...
    @if (!empty(Route::currentRouteName()) && (Route::currentRouteName() == 'search.ad' || Route::currentRouteName() == 'searchdemande.ad'))
        ...
        {{-- <link href="https://res.cloudinary.com/dl7aa4kjj/raw/upload/v1655708086/Bailti/js/style_wylqqr.css"
            rel="stylesheet"> --}}
    ...
    @else
        ...
        <link href="https://res.cloudinary.com/dl7aa4kjj/raw/upload/v1655708271/Bailti/js/include_jqv7iz.css" rel="stylesheet">
...
<!--No Footer -->
    ...
    <script>
        $(document).ready(function() {
            ...
            if(pathname == '/modifier-profile'){
                $('.file-footer-buttons:first').prepend( '<button type="button" id="btn-rotate-left" class="btn btn-kv btn-default btn-outline-secondary rotate-270 btn-rotation" data-id="270" title="Rotation -90°"><i class="fa fa-home fa-rotate-left"></i></button>' );
                $('.file-footer-buttons:first').prepend( '<button type="button" id="btn-rotate-right" class="btn btn-kv btn-default btn-outline-secondary rotate-90 btn-rotation" data-id="90" title="Rotation 90°"><i class="fa fa-rotate-right"></i></button>' );

                var rotateDegrees = 0;
                $("#btn-rotate-left").on("click", function(){
                    rotateDegrees += -90;
                    console.log(rotateDegrees);
                    $('.file-preview-image:first').css('transform','rotate('+ rotateDegrees +'deg)');
                    $('#pdp_rotate').remove();
                    $('.file-footer-buttons:first').prepend( '<input id="pdp_rotate" type="hidden" name="pdp_rotate" value="'+ rotateDegrees +'">' );
                });
                ...
                $( "#file-profile-photo" ).change(function() {
                    $('#pdp_rotate').remove();
                    setTimeout(function(){
                        $('.file-footer-buttons:first').prepend( '<button type="button" id="btn-rotate-left" class="btn btn-kv btn-default btn-outline-secondary rotate-270 btn-rotation" data-id="270" title="Rotation -90°"><i class="fa fa-home fa-rotate-left"></i></button>' );
                        $('.file-footer-buttons:first').prepend( '<button type="button" id="btn-rotate-right" class="btn btn-kv btn-default btn-outline-secondary rotate-90 btn-rotation" data-id="90" title="Rotation 90°"><i class="fa fa-rotate-right"></i></button>' );
