...
@push('scripts')
    ...
    <script src="{{ asset('js/rentaproperty.js') }}"></script>
...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div
                    ...
                    <div
                        class="step-content step-1-content rent-property-form-content project-form rp-step-1-content white-bg m-t-20">
    ...
    <ul>
        ...
        <li class="step-3-menu menu visiting-menu"><a href="javascript:void(0);"><span>3</span><h6>{{ __('property.visit_details') }}</h6></a></li>
                        ...
                        <form id="firstStep" method="POST" enctype="multipart/form-data"
                              action="{{ route('save.step1') }}">
                            {{ csrf_field() }}

                            <input type="hidden" id="scenario_id" name="scenario_id" value="1">
                            <input type="hidden" name="edite" id="button_edite"
                                   value="{{ (isset($edite)&&$edite==1)?'edite':'' }}">
                            @if(!empty($ad_details))
                            ...
                            <div class="form-group">
                                <label class="control-label" for="address">{{ __('property.quel_adresse_louer') }}
                                    *</label>
                                <div class="input-group" id="autocomplete-container">
                                    <span class="input-group-addon"><i class="fa fa-map-marker"></i></span>
                                    <input id="address" name="address" class="form-control" type="text"
                                           placeholder="{{ __('property.placeholder_adress') }}"
                                           @if(!empty($ad_details)) value="{{$ad_details->address}}"
                                           @endif @if(!empty($AdInfo)) value="{{$AdInfo->address}}"
                                           @endif @if(!empty($address)) value="{{$address}}" @endif>
                                    <input type="hidden" id="latitude" name="latitude"
                                           @if(!empty($ad_details)) value="{{$ad_details->latitude}}"
                                           @endif @if(!empty($AdInfo)) value="{{$AdInfo->latitude}}"
                                           @endif @if(!empty($latitude)) value="{{$latitude}}" @endif>
                                    <input type="hidden" id="longitude" name="longitude"
                                           @if(!empty($ad_details)) value="{{$ad_details->longitude}}"
                                           @endif @if(!empty($AdInfo)) value="{{$AdInfo->longitude}}"
                                           @endif @if(!empty($longitude)) value="{{$longitude}}" @endif>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title"
                                       ...
                                       @if(!empty($ad_details)) value="{{$ad_details->title}}" @endif autofocus>
                                <span class="text-danger">{{ $errors->first('title') }}</span>

                            </div>
                            @if(isSuperUser())
                                <div class="form-group">
                                    <label class="control-label" for="title">{{ __('property.add_url') }}</label>
                                    <input type="text" class="form-control" id="ad_url" placeholder="Url de l'annonce"
                                           name="ad_url" @if(!empty($ad_details)) value="{{$ad_details->custom_url}}"
                                           @endif autofocus>
                                </div>
                            @endif
                            <div class="form-group">
                                ...
                                <textarea id="description" name="description" class="form-control"
                                          placeholder="{{ __('property.description_placeholder') }}" rows="6">@if(!empty($ad_details))
                            ...
                            <div class="form-group">
                                <label class="control-label"
                                       for="proximity">{{ __('property.point_proximity') }}</label>
                                    ...
                                    <select id="proximity" placeholder="{{__('filters.no_selected')}}"
                                        ...
                                        @if(count($proximities)>0)
                                            @foreach($proximities as $proximity)
                                                <option
                                                    value="{{$proximity->id}}" {{ in_array($proximity->id, $proximities_array) ? 'selected' : '' }}>{{ $proximity->title }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="div-metro">
                                    <input type="text" class="form-control metro_lines" id="metro_line"
                                           placeholder="{{ __('property.metro_lines_placeholder') }}" name="metro_line">
                                    ...
                                    @foreach($ad_details->nearby_facilities as $key => $nearby)
                                        @if($nearby->nearbyfacility_type == "subway_station")
                                            <div class="metro-elem">{{$nearby->name}}<a href="javascript:"
                                                    ...
                                                    type="hidden" name="metro_lines[]" value="{{$nearby->name}}"/></div>
                                        @endif
                                    @endforeach
                                @endif
                            </div>
                            @if(!$standard)
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="sous_loc_type">{{ __('property.type_location') }}
                                        *</label>
                                    <div class="custom-selectbx">
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="property_type">{{ __('property.property_type') }}
                                        *</label>
                                    <div class="custom-selectbx">
                                ...
                                <div class="form-group radio2-width">
                                    <label class="control-label">{{ __('property.furnished_or_unfurnished') }}?
                                        *</label>
                                    <div class="filter-radio-listing">

                                        <div class="custom-radio">
                                            <input type="radio" id="fr-un-1" name="furnished" autocomplete="off"
                                                   value="0"/>
                                            <label for="fr-un-1">{{ __('property.furnished') }}</label>
                                        </div>
                                        <div class="custom-radio">
                                            <input type="radio" id="fr-un-2" autocomplete="off" name="furnished"
                                        ...
                                        <div class="form-group">
                                            <label class="control-label">{{ __('property.date_availability') }}*&nbsp;<a
                                                    ...
                                                    title="{{ __('Date of availablity of the property') }}"><i
                                                        class="fa fa-question-circle fa-lg" aria-hidden="true"></i></a></label>
                                            <div class="datepicker-outer">
                                                <div id="datepicker-1" class="custom-datepicker">
                                                    <input class="form-control" type="text" id="date_of_availablity"
                                                           @if(!empty($ad_details) && !empty($ad_details->available_date)) value="{{date("d/m/Y", strtotime($ad_details->available_date))}}"
                                                           @endif name="date_of_availablity" placeholder="dd/mm/yyyy">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input id="prop_square_meters" type="text" class="form-control"
                                                   ...
                                                   @if(!empty($ad_details)) value="{{$ad_details->ad_details->min_surface_area}}" @endif>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label"
                                           for="guarantee_type_1">{{ __('property.guarantee_ask') }}?</label>
                                    <div class="custom-selectbx">
                                        <select id="guarantee_type_1" sumo-required="true"
                                                placeholder="{{__('filters.no_selected')}}" name="guarantee_type[]"
                                                class="sumo-select" multiple="">
                                            @foreach($guarAsked as $data)
                                                <option
                                                    value="{{$data->id}}">{{traduct_info_bdd($data->guarantee)}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="pr-form-ftr">
                                @if($standard)
                                    ...
                                    <div class="submit-btn-1 save-nxt-btn"><input type="submit" name="Save & Next"
                                                                                  value="{{ __('property.save_next') }}"
                                                                                  id="savenext_button_st_1"/></div>
                                @else
                                    <div class="submit-btn-1 save-nxt-btn"><input type="submit" name="Save"
                                                                                  value="{{ __('property.save') }}"
                                                                                  id="save_button_standard"/></div>
                                @endif
                            </div>
                        </form>
                    </div>
                    <div
                        class="step-content step-2-content rent-property-form-content project-form rp-step-2-content white-bg m-t-20">
                        <div class="rent-property-form-hdr">
    ...
    <ul>
        ...
        <li class="step-3-menu menu visiting-menu"><a href="javascript:void(0);"><span>3</span><h6>{{ __('property.visit_details') }}</h6></a></li>
                        ...
                        <form id="secondtStep" method="POST" enctype="multipart/form-data"
                              action="{{ route('save.step2') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="row">
                                <div class="col-xs-10 col-sm-3 col-md-3">
                                    <div class="form-group">
                                        <label class="control-label"
                                               for="sous_loc_type">{{ __('property.type_location') }} *</label>
                                        <div class="custom-selectbx">
                                            <select id="sous_loc_type" name="sous_loc_type" class="selectpicker">
                                                @foreach($sous_type_loc as $data)
                                                    @if(!empty($ad_details) && $ad_details->sous_type_loc == $data->id)
                                        ...
                                        <div class="custom-radio">
                                            @if(!empty($ad_details) && !is_null($ad_details->ad_details->bedrooms) && $ad_details->ad_details->bedrooms!=0)
                                                @if($ad_details->ad_details->bedrooms == $i)
                                                    <input type="radio" id="rpt-bedroom-op{{$i}}" name="no_of_bedrooms"
                                                           autocomplete="off" checked="checked" value="{{$i}}"/>
                                                @else
                                                    <input type="radio" id="rpt-bedroom-op{{$i}}" name="no_of_bedrooms"
                                            ...
                                            @else
                                                <input type="radio" id="rpt-bedroom-op{{$i}}" name="no_of_bedrooms"
                                                       autocomplete="off" @if ($i==1) checked="checked"
                                                       @endif value="{{$i}}"/>
                                            @endif
                                            <label for="rpt-bedroom-op{{$i}}">@if ($i==11)
                                                    10+
                                                @else
                                                    {{$i}}
                                                @endif @if ($i==1)
                                        ...
                                        <div class="custom-radio">
                                            @if(!empty($ad_details) && !is_null($ad_details->ad_details->bathrooms) && $ad_details->ad_details->bathrooms!=0)
                                                @if($ad_details->ad_details->bathrooms == $i)
                                                    <input type="radio" name="no_of_bathrooms" autocomplete="off"
                                                           id="rpt-bathroom-op{{$i}}" checked="checked" value="{{$i}}"/>
                                                @else
                                                    <input type="radio" name="no_of_bathrooms" autocomplete="off"
                                                           id="rpt-bathroom-op{{$i}}" value="{{$i}}"/>
                                                @endif
                                            @else
                                                <input type="radio" name="no_of_bathrooms" autocomplete="off"
                                                       id="rpt-bathroom-op{{$i}}" @if ($i==1) checked="checked"
                                                       @endif value="{{$i}}"/>
                                            @endif
                                        ...
                                        <div class="custom-radio">
                                            @if(!empty($ad_details) && !is_null($ad_details->ad_details->partial_bathrooms))
                                                @if($ad_details->ad_details->partial_bathrooms == $i)
                                                    <input type="radio" name="no_of_part_bathrooms" autocomplete="off"
                                                           id="prpt-bathroom-op{{$i}}" checked="checked"
                                                           value="{{$i}}"/>
                                                @else
                                                    <input type="radio" name="no_of_part_bathrooms" autocomplete="off"
                                                           id="prpt-bathroom-op{{$i}}" value="{{$i}}"/>
                                                @endif
                                            @else
                                                <input type="radio" name="no_of_part_bathrooms" autocomplete="off"
                                                       id="prpt-bathroom-op{{$i}}" @if ($i==0) checked="checked"
                                                       @endif value="{{$i}}"/>
                                            @endif
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-4 col-md-4">
                                    <div class="form-group">
                                        <label class="control-label" for="rent_per_month">{{ __('property.rent') }}
                                            *</label>
                                ...
                                <div class="col-xs-12 col-sm-4 col-md-4">
                                    <div class="form-group">
                                        <label class="control-label"
                                               for="deposit_price">{{ __('property.deposit_price') }}</label>
                                        <input type="text" class="form-control" id="deposit_price" placeholder="{{get_current_symbol()}}"
                                               name="deposit_price"
                                               @if(!empty($ad_details) && $ad_details->ad_details->deposit_price != null) value="{{$ad_details->ad_details->deposit_price }}" @endif>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-4 col-md-4">
                                    <div class="form-group">
                                        <label class="control-label"
                                               for="broker_fees">{{ __('property.broker_fees') }}</label>
                                        <input type="text" class="form-control" id="broker_fees" placeholder="{{get_current_symbol()}}"
                                               name="broker_fees"
                                               @if(!empty($ad_details) && $ad_details->ad_details->broker_fees != null) value="{{$ad_details->ad_details->broker_fees }}" @endif>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group addu-outer">
                                <input class="custom-checkbox" id="addu-checkbox-1" type="checkbox"
                                       name="add_utility_cost"
                                       @if(!empty($ad_details) && $ad_details->ad_details->add_utility_costs == 1) checked="checked"
                                       @endif value="1" data-toggle="collapse" data-target="#utility_cost_div">
                                <label class="control-label"
                                       for="addu-checkbox-1">{{ __('property.add_utility_cost') }}</label>
                            </div>
                            <div
                                class="row collapse @if(!empty($ad_details) && $ad_details->ad_details->add_utility_costs == 1) in @endif"
                                id="utility_cost_div">
                                <div class="col-xs-12 col-sm-4 col-md-4">
                                    <div class="form-group">
                                        <label class="control-label"
                                               for="utility_cost">{{ __('property.utility_cost_per_month') }} *</label>
                                        <input type="text" placeholder="{{get_current_symbol()}}" class="form-control" id="utility_cost"
                                               name="utility_cost"
                                               @if(!empty($ad_details) && $ad_details->ad_details->utility_cost != null) value="{{$ad_details->ad_details->utility_cost}}" @endif>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    @foreach($propFeatures as $data)
                                        <li>
                                            @if(!empty($property_features_array) && in_array($data->id, $property_features_array))
                                                <input class="custom-checkbox" id="pf-checkbox-{{$data->id}}"
                                                       type="checkbox" checked="checked" name="prop_feature[]"
                                                       value="{{$data->id}}">
                                            @else
                                                <input class="custom-checkbox" id="pf-checkbox-{{$data->id}}"
                                                       type="checkbox" name="prop_feature[]" value="{{$data->id}}">
                                            @endif

                                            <label for="pf-checkbox-{{$data->id}}">@if(!empty($data->icon_image))
                                                    <img src="{{URL::asset('images/icons/' . $data->icon_image )}}"
                                                         alt="{{$data->feature}}">
                                                @endif{{traduct_info_bdd($data->feature)}}</label>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
                                    ...
                                    @foreach($buildAmenities as $data)
                                        <li>
                                            @if(!empty($amenities_array) && in_array($data->id, $amenities_array))
                                                <input class="custom-checkbox" id="ba-checkbox-{{$data->id}}"
                                                       type="checkbox" name="building_amenities[]" checked="checked"
                                                       value="{{$data->id}}">
                                            @else
                                                <input class="custom-checkbox" id="ba-checkbox-{{$data->id}}"
                                                       type="checkbox" name="building_amenities[]"
                                                       value="{{$data->id}}">
                                            @endif
                                            <label for="ba-checkbox-{{$data->id}}">@if(!empty($data->icon_image))
                                                    <img src="{{URL::asset('images/icons/' . $data->icon_image )}}"
                                                         alt="{{$data->amenity}}">
                                                @endif{{traduct_info_bdd($data->amenity)}}</label>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
                            ...
                            <div class="form-group radio2-width">
                                ...
                                <div class="filter-radio-listing">
                                    @if(!empty($ad_details) && $ad_details->ad_details->apl_rights == '1')
                                        <div class="custom-radio">
                                            <input type="radio" id="apl-radio-1" name="apl_right" autocomplete="off"
                                                   checked="checked" value="1"/>
                                            <label for="apl-radio-1">{{ __('property.yes') }}</label>
                                        </div>
                                        <div class="custom-radio">
                                            <input type="radio" id="apl-radio-2" autocomplete="off" name="apl_right"
                                                   value="0"/>
                            ...
                            <div class="form-group radio2-width">
                                ...
                                <div class="filter-radio-listing">
                                    @if(!empty($ad_details) && $ad_details->ad_details->advertising_as == '0')
                                        <div class="custom-radio">
                                            <input type="radio" id="advertising-radio-1" name="advertising_as"
                                                   autocomplete="off" checked="checked" value="0"/>
                                            <label for="advertising-radio-1">{{ __('property.roommate') }}</label>
                                        </div>
                                        <div class="custom-radio">
                                            <input type="radio" id="advertising-radio-2" autocomplete="off"
                                                   name="advertising_as" value="1"/>
                                            <label for="advertising-radio-2">{{ __('property.landlord') }}</label>
                                        </div>
                                        <div class="custom-radio">
                                            <input type="radio" id="advertising-radio-3" autocomplete="off"
                                                   name="advertising_as" value="2"/>
                                    ...
                                    @elseif(!empty($ad_details) && $ad_details->ad_details->advertising_as == '2')
                                        ...
                                        <div class="custom-radio">
                                            <input type="radio" id="advertising-radio-3" autocomplete="off"
                                                   name="advertising_as" checked="checked" value="2"/>
                                            <label for="advertising-radio-3">{{ __('property.agent') }}</label>
                                        </div>
                                    @else
                                        <div class="custom-radio">
                                        ...
                                        <div class="custom-radio">
                                            <input type="radio" id="advertising-radio-2" autocomplete="off"
                                                   name="advertising_as" checked="checked" value="1"/>
                                            <label for="advertising-radio-2">{{ __('property.landlord') }}</label>
                                        </div>
                                        <div class="custom-radio">
                                            <input type="radio" id="advertising-radio-3" autocomplete="off"
                            ...
                            <div class="form-group">
                                ...
                                <div class="filter-radio-listing">
                                    @if(!empty($ad_details) && $ad_details->ad_details->leasing_fees == '1')
                                        <div class="custom-radio">
                                            <input type="radio" id="leasing-fee-1" name="leasing_fee" autocomplete="off"
                                                   checked="checked" value="1"/>
                                            <label for="leasing-fee-1">{{ __('property.yes') }}</label>
                                        </div>
                                        <div class="custom-radio">
                                            <input type="radio" id="leasing-fee-2" name="leasing_fee" autocomplete="off"
                                                   value="0"/>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="ks-checkbox-bx">
                                            @if(!empty($ad_details) && $ad_details->ad_details->kitchen_separated == '1')
                                                <input class="custom-checkbox" id="ks-checkbox-1" type="checkbox"
                                                       name="separate_kitchen" checked="checked" value="1">
                                            @else
                                                <input class="custom-checkbox" id="ks-checkbox-1" type="checkbox"
                                                       name="separate_kitchen" value="1">
                                            @endif
                                ...
                                <div class="col-xs-12 col-sm-4 col-md-4">
                                    <div class="form-group">
                                        <label class="control-label"
                                               for="min_stay_months">{{ __('property.minim_staying') }}</label>
                                        <div class="custom-selectbx">
                                            <select id="min_stay_months" name="min_stay_months" class="selectpicker">
                                                @for ($i = 0; $i <= 12; $i++)
                                                    @if(!empty($ad_details) && $ad_details->ad_details->minimum_stay == $i)
                                                        <option selected="selected" value="{{$i}}">@if($i==0)
                                                                {{ __('property.no_minim_staying') }}
                                                            @else
                                                                {{$i}}
                                                            @endif</option>
                                                    @else
                                                        <option value="{{$i}}">@if($i==0)
                                                                {{ __('property.no_minim_staying') }}
                                                            @else
                                                                {{$i}}
                                                            @endif</option>
                            ...
                            <div class="form-group">
                                <label class="control-label" for="guarantee_type_1">{{ __('property.guarantee_ask') }}
                                    ?</label>
                                <div class="custom-selectbx">
                                    <select id="guarantee_type_1" placeholder="{{__('filters.no_selected')}}"
                                            name="guarantee_asked[]" class="sumo-select" multiple="">
                                        @foreach($guarAsked as $data)
                                    ...
                                    @foreach($petsAllowed as $data)
                                        <li>
                                            @if(!empty($allowed_pets_array) && in_array($data->id, $allowed_pets_array))
                                                <input class="custom-checkbox" id="prpet-checkbox-{{$data->id}}"
                                                       type="checkbox" name="allowed_pets[]" checked="checked"
                                                       value="{{$data->id}}">
                                            @else
                                                <input class="custom-checkbox" id="prpet-checkbox-{{$data->id}}"
                                                       type="checkbox" name="allowed_pets[]" value="{{$data->id}}">
                                            @endif
                                            <label
                                                for="prpet-checkbox-{{$data->id}}">{{traduct_info_bdd($data->petname)}}</label>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
                                    ...
                                    @foreach($propRules as $data)
                                        <li>
                                            @if(!empty($property_rules_array) && in_array($data->id, $property_rules_array))
                                                <input class="custom-checkbox" id="pr-checkbox-{{$data->id}}"
                                                       type="checkbox" name="property_rules[]" checked="checked"
                                                       value="{{$data->id}}">
                                            @else
                                                <input class="custom-checkbox" id="pr-checkbox-{{$data->id}}"
                                                       type="checkbox" name="property_rules[]" value="{{$data->id}}">
                                            @endif
                                            <label for="pr-checkbox-{{$data->id}}">@if(!empty($data->icon_image))
                                                    <img src="{{URL::asset('images/icons/' . $data->icon_image )}}"
                                                         alt="{{$data->rules}}">
                                                @endif{{traduct_info_bdd($data->rules)}}</label>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
                                ...
                                <ul id="test">
                                    @foreach($adDocuments as $doc)
                                        <li>
                                            ...
                                            <input type="text" class="form-control" name="" placeholder="Document name"
                                                   value="{{$doc->document_name}}">
                                            <div class="document-remove"><a href="javascript:"
                                                                            class="btn-delete-document" data-id="">
                                                    <img src="{{ URL::asset('images/delete.png') }}">
                                                </a></div>
                                            <input type="checkbox" class="custom-checkbox" name=""
                                                   @if($doc->document_required == 1)
                                                       checked="checked"
                            ...
                            <div class="pr-form-ftr">
                                ...
                                <div class="submit-btn-1 back-btn"><input type="button" name="Back"
                                                                          value="{{ __('property.back') }}"
                                                                          id="back_button_st2"/></div>
                                <div class="submit-btn-1 save-nxt-btn"><input type="submit" name="Save & Next"
                                                                              id="savenext_button_st_2"
                                                                              value="{{ __('property.save_next') }}"/>
                                </div>
                            </div>
                        </form>
                    ...
                    <div
                        class="step-content step-3-content rent-property-form-content project-form rp-step-3-content white-bg m-t-20">
                        <div class="rent-property-form-hdr">
    ...
    <ul>
        ...
        <li class="step-3-menu menu visiting-menu"><a href="javascript:void(0);"><span>3</span><h6>{{ __('property.visit_details') }}</h6></a></li>
                        ...
                        <form id="thirdtStep" method="POST" enctype="multipart/form-data"
                              action="{{ route('save.step3') }}">
                            {{ csrf_field() }}
                            ...
                            @if(!empty($ad_details) && !empty($ad_details->ad_visiting_details) && count($ad_details->ad_visiting_details) > 0)
                                @foreach($ad_details->ad_visiting_details as $key=> $visiting_details)
                                    ...
                                    <div class="visit-detail-bx-outer">
                                        @if($key != 0)
                                            <div class="remove-visit-btn"><a href="javascript://;"
                                                                             class="remove_this_visit"
                                                                             data-toggle="tooltip" data-placement="top"
                                                                             title="{{ __('Remove this visit detail.') }}"><i
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-4 col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label"
                                                           for="date_of_visit_{{$key + 1}}">{{ __('property.date') }}</label>
                                                    <div class="datepicker-outer">
                                                        <div class="custom-datepicker">
                                                            <input class="form-control" type="text"
                                                                   id="date_of_visit_{{$key + 1}}"
                                                                   name="date_of_visit[]"
                                                                   @if(!empty($visiting_details->visiting_date)) value="{{date("d/m/Y", strtotime($visiting_details->visiting_date))}}"
                                                                   @endif placeholder="dd/mm/yyyy">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-4 col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label"
                                                           for="start_time_{{$key + 1}}">{{ __('property.start_time') }}</label>
                                                    <input type="text" id="start_time_{{$key + 1}}" name="start_time[]"
                                                           @if(!empty($visiting_details->start_time)) value="{{date("g:i a", strtotime($visiting_details->start_time))}}"
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label"
                                                           for="end_time_{{$key + 1}}">{{ __('property.end_time') }}</label>
                                                    <input type="text" id="end_time_{{$key + 1}}" name="end_time[]"
                                                           @if(!empty($visiting_details->end_time)) value="{{date("g:i a", strtotime($visiting_details->end_time))}}"
                                                           @endif class="form-control" readonly>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label"
                                                   for="note_{{$key + 1}}">{{ __('property.notes') }}</label>
                                            <textarea id="note_{{$key + 1}}" name="note[]" class="form-control"
                                                      placeholder="{{ __('Notes') }}" rows="4">@if(!empty($visiting_details->notes) && $visiting_details->notes != null)
                                                    {{$visiting_details->notes}}
                                                @endif</textarea>
                                        </div>
                                ...
                                <div class="visit-detail-bx-outer">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"
                                                       for="date_of_visit_1">{{ __('property.date') }}</label>
                                                <div class="datepicker-outer">
                                                    <div class="custom-datepicker">
                                                        <input class="form-control" type="text" id="date_of_visit_1"
                                                               name="date_of_visit[]" readonly placeholder="dd/mm/yyyy">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"
                                                       for="start_time_1">{{ __('property.start_time') }}</label>
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                            <div class="form-group">
                                                <label class="control-label"
                                                       for="end_time_1">{{ __('property.end_time') }}</label>
                                                <input type="text" id="end_time_1" name="end_time[]"
                                                       class="form-control" readonly>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="note_1" name="note[]" class="form-control"
                                                  placeholder="{{ __('Notes') }}" rows="4"></textarea>
                                    </div>
                                    <div class="ad-detail-ftr"><p>{{ __('property.notes_placeholder') }}</p></div>
                                </div>
                            @endif
                            <div class="add-new-detail-btn">
                                <a id="add_another_visit_detail"
                                   href="javascript:void(0);">{{ __('property.another_detail_button') }}</a>
                            </div>
                            <input type="hidden" name="button_clicked" id="button_clicked" value="">
                            @guest
                            ...
                            <div class="pr-form-ftr">
                                ...
                                <div class="submit-btn-1 back-btn">
                                    <a href="{{route('user.dashboard')}}" class="btn btn-secondary btn-lg active"
                                       role="button" aria-pressed="true">Ignorer</a>
                                </div>
                                <div class="submit-btn-1 save-nxt-btn"><input type="submit" name="Publish"
                                                                              @if(!empty($ad_details)) value="{{ __('property.save_publish') }}"
                                                                              @else value="{{ __('property.publish') }}"
                                                                              @endif id="savenext_button_st_3"/></div>
                            </div>
                        </form>
                    </div>
                </div>
