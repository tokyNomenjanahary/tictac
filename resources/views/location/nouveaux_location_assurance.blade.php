    ...
    <div class="card-body" style="margin-top: 20px;">
        <div class="row align-middle">
            <div class="col-md-1 align-middle ">
                <label for="" class="form-label">ASSURANCES</label>
            </div>
            <div class="col-md-6 align-middle">
                <a href="" class="btn" data-bs-toggle="modal"
                    style="border:1px solid gray;color:blue;background-color:#f5f5f9;"
                    data-bs-target="#Mydocuments" onmouseup="">
                    <i class="fa fa-plus-circle"></i> Ajouter une assurance
                </a>
            </div>
            <p style="margin-top: 10px;">Vous pouvez ajouter plusieurs contrats. Les fichiers seront sauvegardés
                dans la
                rubrique Documents</p>
        </div>
    </div>
    <!-- Modal Body-->
                ...
                <div class="modal-body">
                    ...
                    <div class="row" style="margin-top:10px;">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" style="border:1px solid #f9f9f9;color:blue;"
                                        ...
                                        aria-selected="true"><i class="fa fa-paperclip"></i>Nouveau</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" style="border:1px solid #f9f9f9;color:blue;"
                                        id="profile-tab" data-bs-toggle="tab" data-bs-target="#complem"
                                        type="button" role="tab" aria-controls="profile"
                                        aria-selected="false"><i class="fa as fa-briefcase"></i>
                                        Déjà existant</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="info_generale" role="tabpanel"
                                ...
                                <div class="row" style="margin-top: 10px;">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="">
                                            <textarea name="" id=""class="form-control" cols="5" rows="2"
                                                placeholder="Description,type,durée..."></textarea>
                                ...
                                <div class="card-body" style="margin-top: -40px">
                                    <div class="">
                                        <label for="" class="form-label">DATE D'ÉTABLISSEMENT</label>
                            ...
                            <div class="tab-pane " id="complem" role="tabpanel" aria-labelledby="profile-tab">
                                <div class="card-body">
                                    <div class="">
                                        ...
                                        <select name="" id="civilite" class="form-control"><span
                                                class="caret"></span>
                                            <option value="">Choisir</option>
                                        </select>
                                        <br>
                                        <p class>Choisissez parmi les fichiers déjà existants dans la rubrique Mes
                                            Documents.</p>
                                    </div>
                                </div>
                                <div class="card-body" style="margin-top: -40px">
