            ...
            <div class="card" style="margin-top: 10px">
                <div class="card-header"style="color:#4C8DCB;padding:10px;background-color:F5F5F9;margin-top:20px;border-radius:0px;">
                    ...
                    <div class="row">
                        <div class="col-12 align-middle">
                            <div class="float-start">
                                <a style="font-size:10px;color:black"><i class="fa-solid fa-location-dot"></i>&nbsp;&nbsp;{{$location->Logement->adresse}}</a><br>
                                ...
                                <a href="" style="font-size:10px;color:#4C8DCB"><i class="fa-solid fa-rectangle-list"></i>&nbsp;&nbsp;{{$location->loyer_HC}} €</a><br>
                            ...
                            <div class="float-end">
                                <button type="button" style="margin-top:40px;margin-rigth:20px" class="btn p-0 dropdown-toggle hide-arrow dropdown-toggle-split" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample_{{$location->Logement->id}}" aria-controls="offcanvasExample"
