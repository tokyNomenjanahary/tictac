...
@section('contenue')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <!-- CARD FILTER -->
            <form action="{{ route('finance.sauver_revenu') }}" method="POST">
                @csrf
                <div class="mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body p-0">
                            <div class="p-3 border-bottom">
                                <div class="mb-3 row">
                                    <label for="montant" class="col-md-2 col-form-label text-md-end">{{__('revenu.Paiments')}}</label>
                                    <div class="col-lg-2">
                                        <div class="input-group">
                                                <input type="number" class="form-control" id="montant"
                                                    placeholder="Montant" name="montant" value="{{ $finance->montant }}">
                                        </div>
                                    </div>
                                    {{-- <div class="col-lg-2">
                                        <div class="input-group">
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <textarea class="form-control" id="Autres_informations" rows="2" name="Autres_informations">@if(!empty($Autres_information->Autres_informations )){{$Autres_information->Autres_informations }} @endif</textarea>
                            ...
                            <div class="mb-3 mt-3 row text-center">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <button class="btn btn-primary" id="modifier-etat">{{__('depense.Sauvegarder')}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('js')
    ...
    <script>
        ...
        $("#modifier-etat").on("click", function(e) {
            e.preventDefault()
            var bien = $("#bien").val()
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route('finance.sauver_revenu') }}',
                data: {
                    bien: bien,
                    location: location,
                    date: date,
