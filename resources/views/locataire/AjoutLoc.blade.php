            ...
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                <div class="row">
                    <div class="col-md-12 p-3">
                        <div class="float-start">
                            <h3><a href="javascript:history.go(-1)"> <i class="fas fa-chevron-left"></i> </a> Nouveau
                                locataire</h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation" id="profile-tab-li" hidden>
                        ...
                        <li class="nav-item" role="presentation" id="messages-tab-li" hidden>
                        ...
                        <li class="nav-item" role="presentation" id="contactUrgence-li" hidden>
                        ...
                        <li class="nav-item" role="presentation" id="" hidden>
                            <a class="nav-link" style="border:1px solid #f9f9f9;" id="messages-tab"
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="information_generale" role="tabpanel"
                             ...
                             style="">
                            @include('locataire.nouveaux_locataire_info_generale')
                        </div>

                        <div class="tab-pane " id="complementaire" role="tabpanel" aria-labelledby="profile-tab">
                            @include('locataire.nouveaux_locataire_info_complemantaire')
                        </div>
                        <div class="tab-pane" id="garants" role="tabpanel" aria-labelledby="messages-tab">
                            @include('locataire.nouveaux_locataire_garants')
                        </div>
                        <div class="tab-pane" id="urgence" role="tabpanel" aria-labelledby="messages-tab">
                            @include('locataire.nouveaux_locataire_urgence')
                        </div>
                        <div class="tab-pane" id="documents" role="tabpanel" aria-labelledby="messages-tab">
                            @include('locataire.nouveaux_locataire_documents')
                        </div>
                    </div>
                </div>
            </div>
