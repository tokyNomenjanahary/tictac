...
<head>
    ...
    <title>{{__('finance.Quittance_de_loyer')}}</title>
    <style>
        #boxes {
    ...
    <div class="container" style="border: 3px solid gray;color:black;background-color:#FFFFFF;padding:30px;">
                        ...
                        <ul style="list-style-type:none;text-align:left;">
                            <li> <strong style="font-size:15px">{{__('echeance.Locataire')}}</strong>
                                <font style="font-size:12px">
                                    ...
                                    {{ $location->Locataire->tenant_first_name . ' ' . $location->Locataire->tenant_last_name }}
                                </font>
                            </li>
                ...
                <div class="row" style="margin-top:70px;padding-left:55px;">
                    <p style="font-size:15px;">
                        Locataire a payé {{ $location->loyer_HC + $location->charge }} €
                        le {{ \Carbon\Carbon::parse($location->debut)->format('d/m/Y') }} <br>
                    </p>
                ...
                <div class="row" style="margin-top: 20px;">
                    <div style="width: 251px; position: relative; float:right; line-height: 11px;text-align:left;margin-top:30px;">
