...
<div style="padding: 30px 20px">
    ...
    <div style="text-align: center">
        <h2>Déclaration d’entrée du locataire</h2>
    </div>
    <div>
        <p>Madame, Monsieur,</p>
        <p>
            Je vous signale l’entrée du locataire ci-après dénommé et vous communique les renseignements en ma possession.
        </p>
        <p>
        ...
        <p>
            Nom et prénoms du (des) propriétaire(s) :
        </p>
