...
@push('styles')
    ...
    <link href="https://res.cloudinary.com/dnnf3mdjs/raw/upload/v1649145382/css/new-filter_aiurav.css" rel="stylesheet">
    {{-- <link href="/css/exception.css" rel="stylesheet"> --}}
    <link href="https://res.cloudinary.com/dnnf3mdjs/raw/upload/v1649145100/css/exception_puxjma.css" rel="stylesheet">
...
<script src="/js/searchrooms.js"></script>
<script src="https://res.cloudinary.com/dnnf3mdjs/raw/upload/v1649163380/js/ad_and_user_subscription_ojpgkg.js"></script>
{{-- <script src="https://res.cloudinary.com/dnnf3mdjs/raw/upload/v1649163412/js/searchrooms_ijn9dw.js"></script> --}}
<script src="https://res.cloudinary.com/dnnf3mdjs/raw/upload/v1649163435/js/slick-img_vhefhf.js"></script>
...
{{-- <script src="https://res.cloudinary.com/dl7aa4kjj/raw/upload/v1657550667/Bailti/js/facility_search_ovh61d.js"></script> --}}

<script src="https://res.cloudinary.com/dnnf3mdjs/raw/upload/v1649162540/js/return_handler.min_jfvujs.js"></script>
@endpush
@section('content')
...
@if (Session::has('message'))
  ...
  <strong>{{ __('alert.sorry') }}</strong> {{ Session::get('message') }}
...
<!-- AFFICHE RECHERCHE -->
    ...
    <div class="container container-result custum-row" id="idlog">
        <div class="row-fuild">
            <div class="rightside-filter-search">
           

                @include('searchlisting.basic.third-scen-data-all')
